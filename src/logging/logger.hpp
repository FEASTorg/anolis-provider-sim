...
public:
    ...
    static void init_from_env(const char *env_var = "ANOLIS_PROVIDER_SIM_LOG_LEVEL");
...
#define PSIM_LOG_INTERNAL(level, component, msg)                                                             \
    do {                                                                                                     \
        ...
        ::anolis_provider_sim::logging::Logger::log(level, _psim_log_component_ss.str(), __FILE__, __LINE__, \
                                                    _psim_log_message_ss.str());                             \
    } while (0)

#define PSIM_LOG_DEBUG(component, msg) \
    PSIM_LOG_INTERNAL(::anolis_provider_sim::logging::LogLevel::Debug, component, msg)
#define PSIM_LOG_INFO(component, msg) PSIM_LOG_INTERNAL(::anolis_provider_sim::logging::LogLevel::Info, component, msg)
#define PSIM_LOG_WARN(component, msg) PSIM_LOG_INTERNAL(::anolis_provider_sim::logging::LogLevel::Warn, component, msg)
#define PSIM_LOG_ERROR(component, msg) \
    PSIM_LOG_INTERNAL(::anolis_provider_sim::logging::LogLevel::Error, component, msg)
