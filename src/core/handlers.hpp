...
void handle_list_devices(const anolis::deviceprovider::v1::ListDevicesRequest &req,
                         anolis::deviceprovider::v1::Response &resp);

/** @brief Describe one device and its capability surface. */
void handle_describe_device(const anolis::deviceprovider::v1::DescribeDeviceRequest &req,
                            anolis::deviceprovider::v1::Response &resp);

/** @brief Read signal values for one device through the device manager. */
void handle_read_signals(const anolis::deviceprovider::v1::ReadSignalsRequest &req,
                         anolis::deviceprovider::v1::Response &resp);

/** @brief Execute a device function by numeric or resolved symbolic identifier.
 */
void handle_call(const anolis::deviceprovider::v1::CallRequest &req, anolis::deviceprovider::v1::Response &resp);
