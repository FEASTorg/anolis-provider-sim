...
void handle_list_devices(
    const anolis::deviceprovider::v0::ListDevicesRequest &req,
    anolis::deviceprovider::v0::Response &resp);

void handle_describe_device(
    const anolis::deviceprovider::v0::DescribeDeviceRequest &req,
    anolis::deviceprovider::v0::Response &resp);

void handle_read_signals(
    const anolis::deviceprovider::v0::ReadSignalsRequest &req,
    anolis::deviceprovider::v0::Response &resp);
