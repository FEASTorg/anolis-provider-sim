...
RemoteEngine::RemoteEngine(
    std::unique_ptr<sim_adapters::ProtocolAdapter> adapter, double tick_rate_hz)
...
void RemoteEngine::register_devices(
  ...
  try {
    ...
    if (tick_rate_hz_ > 0.0) {
      ...
      const auto timeout_ms =
          static_cast<long long>((20.0 / tick_rate_hz_) * 1000.0);
