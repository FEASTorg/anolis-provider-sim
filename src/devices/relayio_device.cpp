    ...
    namespace relayio
    {
        ...
        CapabilitySet get_capabilities()
        {
            ...
            // Functions
            {
                ...
                *f.add_args() = make_arg("enabled", ValueType::VALUE_TYPE_BOOL, true, "Enable/disable relay channel 1");
            ...
            }
            {
                ...
                *f.mutable_policy() = make_policy(FunctionPolicy::CATEGORY_ACTUATE);
                *f.add_args() = make_arg("enabled", ValueType::VALUE_TYPE_BOOL, true, "Enable/disable relay channel 2");
                *caps.add_functions() = f;
            }
        ...
        std::vector<SignalValue> read_signals(const std::vector<std::string> &signal_ids)
        {
            ...
            if (ids.empty())
            {
                ids = {kSigRelayCh1State, kSigRelayCh2State, kSigGpioInput1, kSigGpioInput2};
            }
