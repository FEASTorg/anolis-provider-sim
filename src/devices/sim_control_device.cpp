    ...
    namespace sim_control
    {
        ...
        CapabilitySet get_capabilities()
        {
            ...
            // Functions
            {
                ...
                *f.add_args() = make_arg("device_id", ValueType::VALUE_TYPE_STRING, true, "Target device ID");
                *f.add_args() = make_arg("duration_ms", ValueType::VALUE_TYPE_INT64, true, "Duration in milliseconds", "ms");
            ...
            }
            {
                ...
                *f.add_args() = make_arg("device_id", ValueType::VALUE_TYPE_STRING, true, "Target device ID");
                *f.add_args() = make_arg("signal_id", ValueType::VALUE_TYPE_STRING, true, "Target signal ID");
                *f.add_args() = make_arg("duration_ms", ValueType::VALUE_TYPE_INT64, true, "Duration in milliseconds", "ms");
                *f.mutable_policy() = make_policy(FunctionPolicy::CATEGORY_ACTUATE);
                *caps.add_functions() = f;
            }
            {
                ...
                *f.add_args() = make_arg("device_id", ValueType::VALUE_TYPE_STRING, true, "Target device ID");
                *f.add_args() = make_arg("latency_ms", ValueType::VALUE_TYPE_INT64, true, "Latency in milliseconds", "ms");
                *f.mutable_policy() = make_policy(FunctionPolicy::CATEGORY_ACTUATE);
                *caps.add_functions() = f;
            }
            {
                ...
                *f.add_args() = make_arg("device_id", ValueType::VALUE_TYPE_STRING, true, "Target device ID");
                *f.add_args() = make_arg("function_id", ValueType::VALUE_TYPE_STRING, true, "Target function name");
                *f.add_args() = make_arg("failure_rate", ValueType::VALUE_TYPE_DOUBLE, true, "Failure probability (0.0-1.0)");
                *f.mutable_policy() = make_policy(FunctionPolicy::CATEGORY_ACTUATE);
                *caps.add_functions() = f;
            }
            {
