...
const DeviceAdapter kTempctl{
    ...
    &tempctl::get_device_info,  &tempctl::read_signals, &tempctl::call_function};

const DeviceAdapter kMotorctl{
    &motorctl::get_capabilities, &motorctl_init,          &motorctl::update_physics, &no_update_control,
    &motorctl::get_device_info,  &motorctl::read_signals, &motorctl::call_function};

const DeviceAdapter kRelayio{
    &relayio::get_capabilities, &relayio_init,          &relayio::update_physics, &no_update_control,
    &relayio::get_device_info,  &relayio::read_signals, &relayio::call_function};

const DeviceAdapter kAnalogsensor{
    &analogsensor::get_capabilities, &analogsensor_init,          &analogsensor::update_physics, &no_update_control,
    &analogsensor::get_device_info,  &analogsensor::read_signals, &analogsensor::call_function};
